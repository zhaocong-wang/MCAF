...
from torchvision.models.mobilenetv3 import InvertedResidualConfig, _mobilenet_v3_conf
...
if __name__ == "__main__":
    ...
    model = MobileNetV3(_mobilenet_v3_conf("mobilenet_v3_large")[0], _mobilenet_v3_conf("mobilenet_v3_large")[1],
                        num_classes=2, in_channels=4).cuda()
    # model = torchvision.models.mobilenet_v3_small(weights=False,num_classes=2).cuda()
    ...
    # summary(model, (3, 128, 128))  # 打印模型结构
